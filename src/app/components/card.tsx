...
export default function Card() {
  return (
    ...
    >
      <Image
        className="rounded-[0.25rem] object-cover w-[110px] h-[130px] object-center"
        src="/pos0.webp"
        ...
        priority
      />
      <h2 className="text-[10px]">Купальник с топом красный</h2>
      <p className="text-[12px] font-semibold">4500 руб.</p>
      <Image 
